...
The first step is to _optimistically_ withdraw 1 Matic from Quickswap via a flash swap. This will serve as the capital that we use to execute our arbitrage. Note that in this scenario, we're assuming that:
